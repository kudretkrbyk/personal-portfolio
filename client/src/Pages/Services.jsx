  ...
  return (
    <section id="features" className="bg-dark py-20">
      <Helmet>
        ...
        <meta
          name="description"
          content="Web geliştirme, UI/UX tasarımı, mobil uyumluluk, performans optimizasyonu ve daha fazlası. Kudret Karabıyık'ın uzmanlık alanlarını keşfedin."
        />
        <meta
          property="og:title"
          content="Öne Çıkan Yeteneklerim | Kudret Karabıyık"
        />
        <meta
          property="og:description"
          content="Web geliştirme, UI/UX tasarımı, mobil uyumluluk ve daha fazlası. Kudret Karabıyık'ın sunduğu hizmetleri keşfedin."
        />
