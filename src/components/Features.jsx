  ...
  const features = [
    {
      ...
      description: 'Modern ve responsive web uygulamaları geliştirme konusunda uzmanım.',
    },
    {
      icon: '🎨',
      title: 'UI/UX Tasarım',
    ...
    },
    {
      ...
      description: 'Tüm cihazlarda kusursuz çalışan web siteleri oluşturuyorum.',
    },
    {
      icon: '⚡',
    ...
    },
    {
      icon: '🔒',
      title: 'Güvenlik',
      description: 'Güvenli ve sağlam altyapıya sahip uygulamalar oluşturuyorum.',
    },
    {
      icon: '🔧',
      title: 'Teknik Destek',
      ...
      <div className="container">
        <div className="text-center mb-12">
          ...
          <p className="text-body-color max-w-2xl mx-auto">
            Yazılım geliştirme sürecinde uzmanlaştığım alanlar ve size sunabileceğim hizmetler
          </p>
        </div>
